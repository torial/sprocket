...
static Keyword aKeywordTable[] = {
  ...
  { "DECLARE",          "TK_DECLARE",      PROCEDURE,        1      },
  { "DEFINER",          "TK_DEFINER",      PROCEDURE,        1      },
  { "INVOKER",          "TK_INVOKER",      PROCEDURE,        1      },
  { "SECURITY",         "TK_SECURITY",     PROCEDURE,        1      },
